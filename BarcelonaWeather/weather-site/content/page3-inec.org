...
| Provincia de ocurrencia        |      Fecha | Femicidios |
|--------------------------------+------------+------------|
| Santa Elena                    | 2025-11-01 |          0 |
| Loja                           | 2025-02-01 |          0 |
| Zamora Chinchipe               | 2026-02-01 |          0 |
| Santa Elena                    | 2025-06-01 |          0 |
| Azuay                          | 2025-09-01 |          1 |
| Guayas                         | 2025-06-01 |          0 |
| Santo Domingo de los Tsáchilas | 2025-07-01 |          0 |
| Manabí                         | 2025-06-01 |          1 |
| El Oro                         | 2025-02-01 |          0 |
| Cotopaxi                       | 2025-09-01 |          0 |
...
** Diez provincias con mayor número de femicidios

La siguiente gráfica presenta las diez provincias que registraron la
mayor cantidad de femicidios durante el periodo analizado, lo que
permite identificar aquellas con mayor incidencia de casos.


#+begin_src python :session inec :results file graphics :exports both

# Selecciona las diez provincias con mayor número de femicidios
top10 = femicidios_provincia.head(10)

plt.figure(figsize=(9,5)) #Crea el espacio gráfico

# Crea el gráfico de barras
top10.plot(kind="bar")

# Título y etiquetas
plt.title("Diez provincias con mayor número de femicidios (2025-2026)")
plt.xlabel("Provincia")
plt.ylabel("Número de femicidios")

# Gira las etiquetas del eje x para facilitar la lectura
...
# Guarda la imagen
archivo="./images/top10_provincias.png"
...
[[file:images/top10_provincias.png]]


**Interpretación de los datos**

1. **Interpretación de estadísticas descriptivas generales:**
   Se analizaron 336 registros correspondientes a 24 provincias
   durante el periodo 2025-2026. El promedio fue de 0.19 femicidios
   por provincia-mes, lo que indica una baja frecuencia de casos en
   cada unidad de análisis. Además, la desviación estándar fue de 0.47, reflejando una
   variabilidad moderada. Los cuartiles muestran que el 75% de los
   registros no presentó casos, aunque en algunos meses se alcanzó un máximo de 3 femicidios en una provincia.

2. **Interpretación por provincia:**
   Los casos no se distribuyen de forma uniforme en el país. Pichincha
   registró la mayor cantidad de casos (15), seguida de Guayas (9) y
   Esmeraldas (7). En contraste, varias provincias no presentaron
   registros durante el periodo analizado, evidenciando diferencias importantes entre territorios.

3. **Interpretación temporal:**
   Los registros mensuales presentaron variaciones a lo largo del
   periodo, sin mostrar una tendencia creciente o decreciente. El
   mayor número de casos se registró en agosto de 2025 con 7
   femicidios, mientras que julio fue el mes con menor cantidad de casos, con 2.

4. **Conclusión general:**
   El análisis evidencia que los femicidios se concentraron
   principalmente en Pichincha y Guayas,  mientras que la mayoría de
   provincias registró pocos o ningún caso. Aunque predominan los
   valores cero en los registros mensuales, existen meses específicos
   con una mayor concentración de casos, lo que refleja un
   comportamiento desigual tanto en el tiempo como entre provincias.   
* Referencias
...
[[file:index.org][← Inicio]] | [[file:pag2-sumaieee754.org][← Suma IEEE754]]
