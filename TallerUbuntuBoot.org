...
#+PROPERTY: header-args:shell :results output verbatim :exports both
...
#+caption: Resultado del comando lscpu1
#+attr_latex: scale=0.75
#+label: fig:label
[[file:images/lscpu1.jpeg]]

#+caption: Resultado del comando lscpu2
#+attr_latex: scale=0.75
#+label: fig:label
[[file:images/lscpu2.jpeg]]

#+caption: Resultado de lscpi
#+attr_latex: scale=0.75
#+label: fig:label
[[file:images/lscpi.jpeg]]

#+caption: Resultado de lsb_release
#+attr_latex: scale=0.75
#+label: fig:label
[[file:images/lsb_release.jpeg]]

#+caption: Resultado de whoami
#+attr_latex: scale=0.75
#+label: fig:label
[[file:images/whoami.jpeg]]
...
- lscpu ::
  ~lscpu~ Muestra la información detallada acerca la arquitectura y el
...
- lsb\_release -a ::
  ~lsb_release -a~ Muestra la información acerca de la distribución de
...
- lspci ::
  ~lspci~ Lista todos los dispositivos al bus PCI del equipo. Sirve
