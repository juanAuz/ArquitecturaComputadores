...
siguientes preguntas considerando la Tabla \ref{tab:orgd40bb1c} como el
mapa de Memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL. 

\begin{table}[htbp]
\caption{\label{tab:orgd40bb1c}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
