...
siguientes preguntas considerando la Tabla \ref{tab:org91fa3c3} como el
mapa de Memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL. 

\begin{table}[htbp]
\caption{\label{tab:org91fa3c3}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
