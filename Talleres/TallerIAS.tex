...
siguientes preguntas considerando la Tabla \ref{tab:orga04d360} como el
mapa de Memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL. 

\begin{table}[htbp]
\caption{\label{tab:orga04d360}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
